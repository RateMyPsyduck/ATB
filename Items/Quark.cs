...
namespace ATB.Items
{
	public class Quark : ModNPC
	{
		...
		public override string GetChat() {
			...
			chat.Add("Rule of Acquisition number 18 \"A Ferengi without profit is no Ferengi at all.\"");
			chat.Add("Blessed Exchequer, whose greed is eternal, allow this bribe to open your ears and hear this plea from your most devout debtor.");
			chat.Add("What currency do your people use? Latinum? Dilithium? Please don’t say its worthless gold!");
            chat.Add("Where is that useless brother of mine?");
            chat.Add("This war better be over soon. I have a moon to buy.");
            chat.Add("*Mumbling* …Quark’s… Quark’s is fun… hmm hmm hmm RUN!");
