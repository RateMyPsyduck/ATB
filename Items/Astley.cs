...
namespace ATB.Items
{
	...
	public class Astley : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("A little 10th Doctor, a little Winne the Pooh.");
		...
		public override void SetDefaults() {
			Item.width = 23; // Width of the item
			Item.height = 21; // Height of the item
